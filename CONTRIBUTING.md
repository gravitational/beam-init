...
[`good-starter-issue`](https://github.com/gravitational/beam-init/issues?q=is%3Aopen+is%3Aissue+label%3Agood-starter-issue)
...
6. beam-init maintainers will review your code, provide feedback, and ultimately create a
...
- be approved by core beam-init contributors ahead of time
